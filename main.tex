...
\begin{abstract}
  ...
  We describe an exploration system that uses the advantages of the proposed representation to overcome the challenges of monocular visual UAV autonomy, and demonstrate 
repeatable autonomous UAV exploration in unstructured outdoor 3D environments, using only a single onboard monocular camera and an IMU, in simulation and in the real world.
