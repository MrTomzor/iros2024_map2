...
\begin{figure}[!t]
  ...
  \caption{Illustration of the proposed approach. The mapping pipeline estimates depth using virtual (blue) and tracked (red) points from sparse monocular-inertial SLAM (left) running on board the UAV (top) to construct a large-scale map consisting of free-space spheres and obstacle points (right).}
  \label{fig:smap_intro}
\end{figure}
% %%}
...
\begin{figure*}[!ht]
  ...
  \caption{
    ...
    % Low-covariance SLAM points $\mathcal{X}_{in,k}$ and robot pose $\mathbf{p}_k$ at time step $k$ are used to update the map points $\mathcal{X}_{map}$, spheres $\mathcal{S}$ and sphere graph $\mathcal{G}$.
  }
    ...
    % ROW 2
     \begin{subfigure}[b]{\subfigwidth}
      \begin{tikzpicture}
        ...
        \node[anchor=south west,inner sep=0] (a) at (0,0) {\adjincludegraphics[width=1.0\linewidth, trim={{0.0\width} {0.0\height} {0.0\width} {0.0\height}}, clip=true]{monoexplo_bigmaps/2025-10-24_15-24_urban_heightmap_05squares_topdown.png}};
        % THICK HEIGHTMAP
     ...
     \begin{subfigure}[b]{\subfigwidth}
      \begin{tikzpicture}
        ...
        % HEIGHTMAP
        \node[anchor=south west,inner sep=0] (rooftops_map) at (0,0) {\adjincludegraphics[width=1.0\linewidth, trim={{0.0\width} {0.0\height} {0.0\width} {0.0\height}}, clip=true]{monoexplo_bigmaps/2025-10-24_16-28_cave_heightmapscale4.png}};
      \markX[0.15]{3.2}{2.6} 
      \end{tikzpicture}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{\subfigwidth}
      \begin{tikzpicture}
        ...
        \node[anchor=south west,inner sep=0] (a) at (0,0) {\adjincludegraphics[width=1.0\linewidth, trim={{0.0\width} {0.0\height} {0.0\width} {0.0\height}}, clip=true]{monoexplo_bigmaps/2025-10-24_15-40_rooftops_topdown_betterheightmap.png}};
        % THICK HEIGHTMAP
     ...
     \begin{subfigure}[b]{\subfigwidth}
      \begin{tikzpicture}
        ...
        \node[anchor=south west,inner sep=0] (sparse_map) at (0,0) {\adjincludegraphics[width=1.0\linewidth, trim={{0.0\width} {0.0\height} {0.0\width} {0.0\height}}, clip=true]{monoexplo_bigmaps/2025-10-24_15-45_sparse_range2_05squares.png}};
        % THICK HEIGHTMAP
