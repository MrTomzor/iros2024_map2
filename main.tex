...
However, this can be resolved by making the mapping pipeline multimodal and incorporating measurements from low-cost short-range distance sensors (e.g. ultrasonic).
Alternatively, designing a visual front-end that would prioritize detection of such obstacles would solve this as well. 
