...
\begin{abstract}
  ...
  The proposed methods are, to the authors' best knowledge, the first to achieve autonomous exploration in both indoor and outdoor real-world, unknown, unstructured 3D environments at the scale required by search-and-rescue missions, using only a single monocular camera and an IMU onboard a potentially micro-scale UAV. 
  We open-source the code of the proposed methods to provide safety-aware 3D navigation capabilities to any vision-based UAV operating in unknown environments.
