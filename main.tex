...
To represent obstacles, we accumulate the stable 3D points (i.e. with low position covariance) estimated by a sparse monocular SLAM frontend into a set of points $\mathcal{X}_{map}$ with a minimal point-to-point distance $\xi$.
