...
In this paper, we identify three core properties of motion-based depth sensing and show that explicitly designing the mapping and planning based on these principles can enable autonomy at similar scales as with dense range sensors.
...
Our planning approach handles the uncertain depth estimates by flying in the direction of the camera, rapidly replanning when new information is obtained.
...
We extensively evaluate our approach in multiple real-world and simulated scenarios and show that our approach achieves exploration of large-scale unstructured indoor and outdoor areas.
...
\begin{itemize}
  ...
  \item A sphere-based monocular 3D mapping method with perception-coupled modules that significantly increase the reliability of mapped free space and obstacles with unreliable, sparse, motion-based depth data as input 
...
The problem addressed in this paper to actively build an explicit 3D map of free and occupied space in an unknown environment with motion-based monocular depth sensing facilitated by a monocular-inertial SLAM frontend.
