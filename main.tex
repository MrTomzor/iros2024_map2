...
\begin{figure}[htb]
  ...
  \centering
     ...
     \end{subfigure}
  \centering
  \caption{Ablation test results on the urban world. Left: visualization of exploration progress, best runs per method are thick and a marker signifies a crash or mission completion. Right: best-run trajectories for each method.
  }
  \label{fig:exper_fireworld}
\end{figure}
