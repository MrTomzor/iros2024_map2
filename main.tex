...
The qualitative results can be seen in \autoref{table:sim_exper} and the resulting maps of the best runs are shown in \autoref{fig:exper_cranes}.
...
\begin{table}[h!]
\centering
  \begin{tabular}{p{16mm} p{20mm} p{18mm} p{12mm}} 
 \hline
    Open-Space Sampling & Mean Volume Explored [$m^3$] & Mean Visited Viewpoints & Collision rate \\ [0.5ex] 
 \hline\hline
 Enabled  & 43951.51 & 124.12 & 3/10 \\ 
 Disabled & 15412.28 & 76.75 & 2/10 \\
 \hline
\end{tabular}
  \caption{Quantitative results of the smaller-scale exploration tests described in \autoref{sec:sim_exper}}
...
\begin{figure}[htb]
  ...
  \centering
     ...
     \hfill
  \centering
  \caption{Comparsion of the best-result maps with the open-area free-space sampling disabled (middle) and enabled (bottom) in the smaller-scale exploration experiment.
  }
