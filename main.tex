...
the UAV is controlled to always aim in the direction of its camera.
...
\fix{With this implementation, the mapping runs on average at $\SI{4.5}{\hertz}$ on average on 
% a standard CPU.
