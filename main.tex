...
\fix{\subsection{Depth Interpolation and Polyhedron Construction}
...
\fix{\subsection{Open-Area Virtual-Depth Estimation (OVDE)}
\label{sec:fake}
...
\fix{\subsection{Distance-Based Obstacle Filtering (DBOF)}
...
\fix{\subsection{Updating and Adding New Spheres}}
...
\fix{\section{Perception-Coupled Exploration with a Sparse Sphere-Based Map}}
...
\fix{\subsection{Multi-World Simulation Evaluation}}
\label{sec:sim_exper}
...
\fix{\subsection{Simulation Results Discussion}}
\fix{
...
\fix{\subsection{Ablation Experiments}
\label{sec:ablations}
