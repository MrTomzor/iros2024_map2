...
In this paper, we care primarily about mapping the free space for planning purposes, and thus we do not perform the mesh optimization or split the 2D interpolations as in \cite{flame}.
...
When moving in open areas, such as over a field, visual SLAM often tracks only a few keypoints on the ground, as illustrated in \autoref{fig:mapping_pipeline}.
...
This approximation does not hold in the case of large textureless walls, but works quite well in the vast majority of real-world environments.
