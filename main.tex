...
MonoSpheres: Monocular-Inertial 3D Mapping for UAV Exploration in Large-Scale Environments}
...
\begin{enumerate}
  ...
  \item A novel 3D mapping approach that constructs a sphere-based map for safe map-based navigation using only sparse pointclouds and the trajectory from monocular-inertial SLAM as input, with less conservative free-space estimation than traditional ray-casting methods.
