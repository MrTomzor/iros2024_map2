...
\begin{abstract}
  ...
  The proposed methods are, to the authors' best knowledge, the first to achieve autonomous exploration in both indoor and outdoor unstructured 3D environments at the scale required by search-and-rescue missions, using only a single monocular camera and an IMU onboard a UAV. 
