...
We test the capabilities of our method in several real-world and simulated environments. 
  To the best of the authors' knowledge, the proposed method is the first to achieve both indoor and outdoor 3D monocular exploration in environments up to 100x100m in scale.
...
We have tested the proposed approach extensively in a variety of other real-world environments, including an orchard, a forest path, and a campsite, which our method also explored.
...
\todo{To further analyze the benefit of this feature of the mapping, we also evaluated the performance of the pipeline with the open-space free-space sampling disabled. As expected, this ablation leads to similar performance in the enclosed cave world, but fails in the outdoor world.}
...
Alternatively, designing a visual front-end that would prioritize detection of such obstacles could help as well, but that is outside the scope of this paper.
