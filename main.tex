...
\begin{enumerate}
  ...
  \item A novel 3D mapping approach, which constructs a sphere-based map using sparse pointclouds obtained from monocular-inertial SLAM as the only depth information.
    ...
    \item Perception-aware exploration that demonstrates large-scale 3D outdoor exploration on a UAV equipped with only a monocular camera and IMU, enabled by the proposed mapping method and 
