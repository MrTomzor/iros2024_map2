...
Nevertheless, since this issue arises only close to such obstacles, it could be simply resolved by incorporating single-point measurements from a low-cost short-range distance sensor (e.g. ultrasonic) into the mapping.
