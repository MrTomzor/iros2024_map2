...
The mapping runs on-board in real-time, using only the pose and 3D landmark information from visual SLAM as its inputs, approximately at 5Hz.
...
\subsection{Motion-Based Free-Space Estimation for Open Areas}
