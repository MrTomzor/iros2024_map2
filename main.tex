...
\begin{enumerate}
  ...
  \item \todo{A novel conceptual approach to 3D mapping} that constructs a sphere-based map for safety-aware navigation using only sparse pointclouds and pose estimates from monocular-inertial SLAM as input,
