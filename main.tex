...
MonoSphere: Monocular-Inertial Mapping for UAV Exploration in Large-Scale 3D Environments}
...
This is designed to solve a problem that can arise when viewing some surface from a much higher distance than before (e.g. observing a wall from 5 m, and then later from 20m) ---
