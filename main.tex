...
\markboth{IEEE Robotics and Automation Letters. Preprint Version. Accepted April, 2026}
{Musil \MakeLowercase{\textit{et al.}}: MonoSpheres} 
...
\IEEEPARstart{I}{n} recent years, significant advances have been presented in mobile robot autonomy, enabling robot systems to explore unknown 3D environments that span kilometers in scale \cite{darpa_cerberus_wins, csiro_darpa, beneath}. 
