...
\fix{We designed the Earthquake environment in \autoref{sec:sim_exper}
 to test the limits of MonoSpheres with the current depth estimation frontend, making it contain textureless surfaces and thin obstacles.
As expected, this has led to collisions in both MonoSpheres and the grid-based mapping method, showing that it is a problem of the sparse depth estimation frontend.
