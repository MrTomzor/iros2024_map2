    ...
    % ROW 2
     ...
     \begin{subfigure}[b]{\subfigwidth}
      \begin{tikzpicture}
        ...
        % HEIGHTMAP
        \node[anchor=south west,inner sep=0] (a) at (0,0) {\adjincludegraphics[width=1.0\linewidth, trim={{0.0\width} {0.0\height} {0.0\width} {0.0\height}}, clip=true]{fig/monoexplo_bigmaps/2025-10-24_15-48_cave_2600_05squares.png}};
      \end{tikzpicture}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{\subfigwidth}
