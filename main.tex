...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
  We present a new method of estimating inverse depth and using such estimates to build an occupancy map composed of spheres and points, using only a single RGB camera and even noisy localization. 
...
TODO - neuro approaches - work, yes, but! domain, and training, and GPU

TODO - flame, mention that its good, but very sensitive to wrong localization (our too? but can toggle on ROBUST method, which does own visual SLAM - contrib over them!)

TODO - that one from Tom, similar to Flame
\subsection{Occupancy Representations}
...
\subsection{RGB-Only Autonomous Navigation}
...
\subsection{Sphere-Based Occupancy Map}
...
\section{Experiments}
\subsection{Real-World Monocular-Inertial Exploration}
