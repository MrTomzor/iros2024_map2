...
\begin{abstract}
  ...
  The mapping module solves the problems of sparse depth data, free-space gaps, and large depth uncertainty by interpolating free space in texture-sparse areas and keeping track of obstacle measurement distances.
