...
\end{minipage}
  ...
  \centering
  \caption{\cfix{Trajectories of the best MonoSpheres (black) and Grid-Based explorer (blue) simulation experiments per each of the 4 world (top) along with the resulting MonoSpheres mapped obstacle points (bottom) colored by height. X marks the starting position.}
  }
