...
\begin{enumerate}
  ...
  \item A novel 3D mapping approach that constructs a scale-invariant sphere-based map directly from sparse pointclouds obtained by monocular-inertial SLAM, without needing any intermediate occupancy map, mapping both open-space and cluttered areas.
