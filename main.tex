...
We compare the grid-based approach with MonoSpheres in multiple experiments on 4 different worlds using the same parameters, and terminate each run after \SI{20}{\minute} (\SI{40}{\minute} in the Cave world due to its size) or sooner if a collision occurs.
